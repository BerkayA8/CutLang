    ...
    */
    ...
    for(ip[0] = 0; ip[0] < collection_sizes[0]; ip[0]++) {
        ...
        for(ip[1] = 0; ip[1] < collection_sizes[1]; ip[1]++) { 
            ...
            if (maxDepth > 1 && ip[0] == ip[1] && collection_types[0] == collection_types[1]) { DEBUG("Repeated\n"); continue; }
            
            for(ip[2] = 0; ip[2] < collection_sizes[2]; ip[2]++) {

                if (Forbidden_Indices.find(ip[2]) != Forbidden_Indices.end()) { DEBUG("FORBIDDEN\n"); continue; }
                if (maxDepth > 2 && ( (ip[0] == ip[2] && collection_types[0] == collection_types[2]) || 
                ...
                for(ip[3] = 0; ip[3] < collection_sizes[3]; ip[3]++) {
                    ...
                    if (maxDepth > 3 && ( (ip[0] == ip[3] && collection_types[0] == collection_types[3]) || 
                    ...
                    for(ip[4] = 0; ip[4] < collection_sizes[4]; ip[4]++) {
                        ...
                        if (maxDepth > 4 && ( (ip[0] == ip[4] && collection_types[0] == collection_types[4]) || 
                        ...
                        for(ip[5] = 0; ip[5] < collection_sizes[5]; ip[5]++) {
                            ...
                            if (maxDepth > 5 && ( (ip[0] == ip[5] && collection_types[0] == collection_types[5]) || 
